                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <c:if test="${q.getImageUrl() != 'NULL-IMAGE'}">
                                    <div class="rounded-xl overflow-hidden border border-gray-100">
                                        <img src="./serve/${q.getImageUrl()}" alt="${q.getTitle()}" class="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500">
                                    </div>
                                </c:if>
                                ...
                                <c:choose>
                                    <c:when test="${q.getAnswerCount() == 0}">
                                        <div class="flex items-center justify-between mt-2 pt-4 border-t border-gray-50">
                                            ...
                                            <a href="./discussion/${q.getQuestionId()}" class="border-2 border-[#27138B] text-[#27138B] px-6 py-2 rounded-xl cursor-pointer text-xs font-bold hover:bg-[#27138B] hover:text-white transition-all">
                                    ...
                                    <c:otherwise>
                                        <div class="flex items-center justify-between mt-2 pt-4 border-t border-gray-50">
                                            ...
                                            <a href="./discussion/${q.getQuestionId()}" class="bg-[#27138B] text-white px-6 py-2.5 rounded-xl cursor-pointer text-xs font-bold hover:bg-[#CDB0FF] hover:text-[#27138B] transition-all shadow-sm">
                                                View Discussion
                                            </a>
                                        </div>
                                    </c:otherwise>
