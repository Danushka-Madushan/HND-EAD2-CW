<%-- 
    Document   : dashboard
    Created on : Mar 22, 2026, 10:25:58 PM
    ...
    <body class="bg-[#F5F7FA] min-h-screen text-[#2C2C2C]">
            ...
            <div class="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span class="text-[#CDB0FF] text-[10px] font-bold uppercase tracking-[0.2em]">Management Console</span>
                    </div>
                </div>
        ...
        <main class="max-w-7xl mx-auto px-6 py-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="bg-white p-6 rounded-3xl border border-gray-200 shadow-sm flex items-center justify-between">
                    <div>
                        <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Banned Users</p>
            ...
            <div class="bg-white rounded-3xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-white">
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100">User Details</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Posts</th>
                                <th class="px-6 py-4 text-[10px] font-black text-gray-400 uppercase tracking-widest border-b border-gray-100 text-center">Answers</th>
                        ...
                        <tbody class="divide-y divide-gray-50">
                            <c:forEach var="user" items="${dashboardUsers}">
                                <tr class="hover:bg-[#F5F7FA] transition-colors group">
                                    <td class="px-6 py-5">
                                        <div class="flex items-center gap-3">
                                            <img src="${user.getProfilePicUrl()}" alt="Author" class="w-10 h-10 rounded-full border border-gray-100">
                                            <div>
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        <span class="inline-block px-3 py-1 bg-gray-100 rounded-full text-xs font-bold text-gray-600">${user.getQuestionCount()}</span>
                                    </td>
                                    <td class="px-6 py-5 text-center">
                                        <span class="inline-block px-3 py-1 bg-emerald-50 rounded-full text-xs font-bold text-emerald-600">${user.getAnswerCount()}</span>
                                    </td>
                                    <td class="px-6 py-5">
                ...
                <div class="p-6 bg-gray-50/50 border-t border-gray-100">
                    <p class="text-xs font-bold text-gray-400 uppercase tracking-widest">End of user list • Total ${dashboardData.getTotalUsers()} Users</p>
                </div>
            </div>
        ...
        <script>
            ...
            function DeleteConfirmation(userId) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        window.location.href = '${pageContext.request.contextPath}/deleteUser/' + userId + "-1";
                    }
                });
            }
